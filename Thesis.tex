...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Accommodation Analysis/Airbnb 3-gram.png}
    \captionsetup{font=footnotesize}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Accommodation Analysis/Booking Positive Scores 3-Gram.png}
    \captionsetup{font=footnotesize}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Accommodation Analysis/Booking Negative Scores 3-gram.png}
    \captionsetup{font=footnotesize}
...
\indent Figure~\ref{fig:clusters_means} presents the mean values of the segmentation variables by cluster, illustrating how the importance assigned to each attribute varies among groups. As shown, Cluster~1 displays lower values for several attributes, such as diversity of local restaurants, availability of museums and art venues, and proximity to outdoor areas, indicating that this segment places relatively greater importance on these aspects compared to the overall population. Cluster~2 shows low scores for tourist information, proximity to natural areas, and historic ambience, suggesting a preference for culturally rich environments supported by accessible information and natural surroundings. Cluster~3 stands out for its low values on accommodation services, flexibility of guided tours, and the density of attractions, highlighting a segment that prioritises convenience, service quality, and accessibility. Finally, Cluster~4 records some of the lowest scores overall, especially for the density of tourist attractions, flexible guided tours, and gastronomy, revealing a highly engaged segment that places strong importance on accessibility, variety, and experiential attributes during travel.
...
\indent Before running the Multinomial Logit model, potential multicollinearity among predictors was assessed. As shown in Figure~\ref{fig:colineality} (see Appendix~\ref{sec:col_matrix}), the correlation matrix indicates moderate correlations among some predictors, particularly between \texttt{historical\_architecture} and \texttt{contemporary\_cultural\_interest}, both related to architectural interest, with a correlation of $0.735$. This relationship was further examined through a VIF analysis (see Figure~\ref{fig:vif} in Appendix~\ref{sec:vif_scores}), which was used to assess potential collinearity between the predictors. Although \texttt{historical\_architecture} showed moderately elevated VIF values relative to the rest of the model, the scores remained well below commonly accepted thresholds for problematic multicollinearity (VIF $<$ 5). Therefore, the analysis did not indicate any serious collinearity issues.
...
& + \texttt{city\_tour\_type} + \texttt{eating\_preference} \\
...
& + \texttt{historical\_architecture (architectural\_interest)} \\
...
& + \texttt{Lake/Rivers (natural\_environment\_type)}
\end{aligned}
\end{equation*}
...
\indent Across all clusters, certain attributes consistently rank as highly important. In particular, “Availability of centrally located accommodation,” “Availability of museums and art venues,” and “Diversity of authentic local restaurants” tend to receive low numerical rankings across several clusters, indicating their broad importance. Conversely, attributes such as “Flexible scheduling of guided tours,” “City located outside major tourist circuits,” and, in some cases, “Accommodation services,” receive higher numerical rankings, suggesting they are perceived as less critical or more situational rather than core determinants of destination choice.

\begin{itemize}
\item Cluster 1 assigns the highest importance to “Diversity of authentic local restaurants”, “Density of tourist attractions within walking distance”, and “Availability of centrally located accommodation”, all of which receive the lowest ranks within this group. This pattern suggests a traveller profile that values gastronomic authenticity, walkable access to attractions, and convenient central lodging. The least important attributes for this cluster are “City located outside major tourist circuits”, “Accommodation services”, and “Flexible scheduling of guided tours”, reflecting a lower emphasis on operational flexibility and on destinations located away from main tourist areas.
\item Cluster 2 places the greatest importance on “Diversity of authentic local restaurants”, “Availability of museums and art venues”, and “Heritage ambience of the historic center”, highlighting a preference for culturally rich, heritage-oriented environments. Its lowest-rated attributes include “City located outside major tourist circuits”, “Availability of tourist information”, and “Flexible scheduling of guided tours”, indicating that this segment values cultural depth more than logistical support or flexible activity scheduling.
\item Cluster 3 ranks “Availability of tourist information”, “Availability of centrally located accommodation”, and “Accommodation services” as its top three attributes, suggesting a segment that prioritises accessibility to information, convenient lodging, and service-oriented amenities. In contrast, “City located outside major tourist circuits”, “Density of tourist attractions within walking distance”, and “Flexible scheduling of guided tours” receive the highest numerical values, revealing a group that favours informational and accommodation-related features over attraction density or operational flexibility.
\item Cluster 4 shows highest importance for “Diversity of authentic local restaurants”, “Availability of museums and art venues”, and “Heritage ambience of the historic center”, indicating a segment that values cultural experiences, local gastronomy, and heritage ambience. Its lowest-ranked attributes include “Density of tourist attractions within walking distance”, “Accommodation services”, and “Flexible scheduling of guided tours”, suggesting a reduced emphasis on walkability, service convenience, and flexible scheduling, pointing instead toward a segment driven primarily by cultural and experiential richness.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Their top priorities include authentic local gastronomy, museums and art venues, and the historic ambience of the destination, reflecting a strong orientation toward culturally rich and heritage-focused environments. Although they are price-conscious, as suggested by their Van Westendorp thresholds, they balance budget constraints with a genuine interest in immersive cultural experiences. This group represents the experiential explorer, guided by curiosity and efficient digital habits.
    \end{itemize}

    \item Cluster 3 (the information-oriented planner):
    \begin{itemize}
        \item This group is almost evenly male and female, mainly 26–35 years old and older people ($>55$). This cluster values accessibility and organisational support in trip planning. They prioritise tourist information, centrally located accommodation, and service-oriented amenities, reflecting a preference for well-structured and convenient travel conditions rather than spontaneous or alternative routes.
        \item Their restaurant choices rely strongly on online reviews, and although they show a moderate preference for less crowded areas, their willingness to travel extra time appears driven more by practical considerations than by a search for unique cultural experiences.
    \end{itemize}

    \item Cluster 4 (the heritage-focused cultural visitor):
    \begin{itemize}
        \item This segment includes a more heterogeneous age range with both young professionals and mature travellers, mainly from South America. They show strong appreciation for cultural authenticity, placing high importance on local gastronomy, museums, and the heritage ambience of the historic centre.
        \item Although convenience remains relevant, their preferences are primarily driven by culturally rich and meaningful experiences rather than logistical or exploratory considerations. They value guided walking tours, and show moderate engagement with natural environments such as mountains or lakes. This group reflects the pragmatic urban tourist, who values cultural identity but prioritises convenience and reliability.
    \end{itemize}
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Accommodation Analysis/Airbnb Top Words.png}
    \captionsetup{font=footnotesize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Accommodation Analysis/Booking Positive Scores Top Words.png}
    \captionsetup{font=footnotesize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Accommodation Analysis/Booking Negative Scores Top Words.png}
    \captionsetup{font=footnotesize}
