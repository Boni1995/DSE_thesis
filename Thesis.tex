...
To my grandmother Chiche, who remains as present as ever. For her unconditional love, for always welcoming me with a smile, and for supporting me at every step, even from afar. Today she guides me from heaven, and her strength accompanies me every day.

To Delfina, my wife, for being the person who always stands by me and with whom I embarked on this beautiful adventure on a new continent. Without her, I might never have dared to take this step.

To my family, especially my parents, because I know that this decision took us physically apart, yet they always supported me from a distance.

To Massimo and Giorgia, for accompanying me through the final stage of this master’s journey, for their continuous support and invaluable feedback, and for introducing me to the beautiful city of Ascoli Piceno.

To my friends in Argentina, and especially to all the friends I met during this wonderful experience here in Italy, who helped me grow personally, brought me closer to new cultures and ways of living that I never imagined, and who stood by me during the hardest moments, encouraging me never to give up.

To myself, because despite my fear of flying, I had the courage to get on the plane and begin this beautiful adventure. And above all, for the perseverance to keep moving forward despite the obstacles along the way.

And to this beautiful country of my bisnonno, which welcomed me to live one of the best experiences of my life. I came as an Argentine and now I am an “argentano,” proud to have returned to my roots.
...
A mi familia, principalmente a mis padres, porque sé que esta decisión nos alejó físicamente, pero aun así siempre me apoyaron a la distancia.

A Massimo y Giorgia, por acompañarme en este último tramo del máster, por su constante apoyo y valiosos comentarios, y por presentarme la hermosa ciudad de Ascoli Piceno.
...
\begin{abstract}
    ...
    Traditional methodological approaches to tourism marketing research often produce fragmented or non-actionable results, limiting their practical usefulness for decision-making. This thesis addresses the question of \textit{``How should a research framework be structured in order to produce reliable and actionable insights for tourism marketing, based on the identification and evaluation of relevant attributes of tourist behavior?"}. It proposes an alternative framework aimed at improving how relevant tourism attributes are identified, analyzed, and validated. 

    The proposed framework integrates text mining with qualitative exploration and quantitative validation into a single, coherent process. Qualitative insights from interviews and open-ended surveys are analyzed using text-embedding and frequency-based methods to uncover new and less obvious attributes of tourist behaviour. These findings inform the design of a refined, closed-ended survey used to test how effectively these attributes capture diverse tourist preferences in a measurable and comparable way.
    ...
    Rather than focusing on a specific destination, the framework emphasizes methodological development and replicability. Ascoli Piceno served as a contextual case, demonstrating how the process can support more reliable, data-driven insights for tourism marketing and destination management. Overall, the findings validate the proposed hypothesis: a mixed-method, text-supported research framework provides a more realistic and useful understanding of tourist decision making than traditional methodologies.
...
\indent This chapter presents the context and motivation of this thesis, which aims to develop an efficient methodological framework for analyzing tourist behavior. It begins with an overview of the tourism sector, highlighting its economic importance and the structural changes introduced by the Covid-19 pandemic. The discussion then presents Ascoli Piceno as the reference case. The chapter continues by outlining the previous project that served as the starting point for this research, identifying its main limitations and lessons learned.
...
\indent This chapter presents a review of the main literature that informs this research. Its goal is to provide the theoretical and methodological background needed to understand the foundations of the study.

\indent The chapter begins by discussing broad research approaches, outlining qualitative and quantitative perspectives as well as their key strengths and limitations. It then introduces central concepts used to analyze tourist behavior, including destination image formation, segmentation, and choice modeling. The review also examines common analytical techniques in tourism research such as discrete choice experiments and conjoint analysis, together with issues that may affect their results, including hypothetical bias.

\indent Finally, the chapter considers more recent contributions that use data-driven methods. In particular, it highlights studies employing text and data mining to extract information from customer feedback, identify relevant attributes, and support segmentation.
...
\indent This chapter describes the methodology used in this research and presents the main results obtained at each stage. The study follows a mixed-methods approach, combining qualitative and quantitative techniques to better understand tourist behavior and preferences.

\indent The first part introduces a series of qualitative interviews, explaining how they were conducted and summarizing the insights gathered from participants. The second part focuses on text mining applied to online accommodation reviews, outlining the analytical process and key findings. The chapter then presents an explanatory survey, including the methods used for data collection and analysis. Different analytical tools are applied, such as exploratory data analysis, price sensitivity assessment, and text-based techniques. This stage also incorporates the discovery of complementary attributes through language-model assistance, which contributes to the refinement of the final set of attributes. The final part of the chapter describes a quantitative survey designed to validate and expand on previous findings.
...
\subsubsection{Text Mining and Topic Modeling}
...
\begin{figure}[ht]  
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Compact Language Detector 2 Results. Source: Author’s own elaboration based on Inside Airbnb's datasets.}}
    \label{fig:cld2}
\end{figure}
...
\indent Following this text preprocessing, the cleaned tokens were converted into numerical features using the TF–IDF method, as described before. Both unigrams (single words) and trigrams (three-word sequences) were extracted using the following algorithm:
...
\begin{figure}[ht]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Top 3-grams from Airbnb Reviews. Source: Author’s own elaboration based on Inside Airbnb's datasets.}}
...
\begin{figure}[ht]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Top 3-grams from Booking.com Positive Reviews. Source: Author’s own elaboration based on Kaggle's dataset.}}
...
\begin{figure}[ht]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Top 3-grams from Booking.com Negative Reviews. Source: Author’s own elaboration based on Kaggle's dataset.}}
...
\indent To further advance the analysis, an explanatory survey (see Appendix~\ref{sec:explanatorysurvey}) was conducted using Microsoft Forms to capture travelers’ perceptions, decision processes, and experiences related to tourism. The survey was available in both English and Spanish and distributed to 25 respondents without disclosing the specific research purpose. Data collection concluded once all 25 responses had been received. This stage functioned as a bridge between the qualitative interviews and the final quantitative survey, serving both to test question clarity and to generate additional insights for refining the set of destination attributes.
...
\indent In the question “Imagine organising a vacation. Sketch a short story of your choice: what would be the 3–4 main scenes?”, each step was analysed separately using TF–IDF vectorisation (see Figure~\ref{fig:organizing}). In the first stage, respondents primarily focused on defining the destination, often new or unexplored places, and aligning it with their available budget. The second stage was mainly described by planning logistics, such as defining travel dates, purchasing plane tickets, booking accommodation, and comparing different options. The third stage focused mainly on defining the itinerary and selecting activities at the destination. The optional fourth stage often repeated previous elements, such as defining accommodation or activities, confirming their importance in the final stages of trip planning.

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Images/Explanatory Survey/Steps of Organizing.png}
    \captionsetup{font=footnotesize}
    \captionof{figure}{\textit{Steps for Organizing a Vacation. Source: Author’s own elaboration.}}
    \label{fig:organizing}
\end{figure}

\indent When analyzing the question realted to choosing between two options, most participants (72\%) preferred option B, primarily due to the possibility of free cancellation. Some also mentioned reviews as a secondary factor. Conversely, those who chose option A (28\%) mainly cited price as the decisive factor. Figure~\ref{fig:screenchoose} displays the most frequent bigrams for each group.
...
\indent For the question “If instead you had to give 3 pieces of advice to your past self about organising a vacation, what would you say?”, two groups were identified. The first included a majority of older participants ($>60$) but also a considerable number of young adults (25–35). The main themes extracted were as follows:
...
\indent To further understand how individual and behavioural characteristics influence cluster membership, a Multinomial Logit (MNL) model was applied. This model allows for the estimation of the probability that a respondent belongs to each of the four clusters identified previously, based on a set of explanatory variables \cite{greene2018econometric}. The dependent variable (\texttt{cluster}) represents the cluster assignment, while the independent variables correspond to respondents’ socio-demographic features and behavioural preferences related to most attributes analyzed previously.

\indent Before estimating the model, a data preparation and transformation process was carried out to ensure consistency and interpretability. The selected dataset included both descriptive variables (such as \texttt{age\_group}, \texttt{gender}, \texttt{residence}, and \texttt{occupation}) and behavioural variables describing decision-making patterns, such as \texttt{define\_accommodation}, \texttt{accommodation\_search}, \texttt{less\_crowded\_willingness}, \texttt{extra\_travel\_time}, and \texttt{architectural\_interest}.  

\indent Categorical variables were recoded into numerical formats to facilitate model estimation. For example, the variable \texttt{define\_accommodation} was coded on a scale from 1 to 3, representing different booking behaviours (advance booking, last-minute booking, or booking directly at destination). Similarly, ordinal variables such as \texttt{extra\_travel\_time} were transformed into numeric values representing the midpoint of each time range (e.g., 1–2 hours → 1.5). Demographic variables were also encoded numerically (\texttt{gender:} male = 1, female = 0; \texttt{residence:} categorical values from 1 to 8).

\indent Several survey questions allowed multiple selections. To handle this structure, each response option was expanded into a binary column (1 if selected, 0 otherwise). To reduce dimensionality and enhance interpretability, these variables were then grouped into broader conceptual categories. For example:
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/Quantitative Survey/answers by gender.png}
    \captionsetup{font=footnotesize}
...
\indent The Davies–Bouldin Index (DBI) supported this conclusion, with the lowest index value also occurring at $k = 4$ (DBI = 3.088), compared with higher values for other configurations. Taken together, the three methods consistently indicated that the most coherent and stable partition of the data corresponds to four clusters, which was therefore adopted for the subsequent analyses.

\indent Overall, after applying multiple validation methods to determine the optimal number of clusters, the analysis concluded that the most appropriate solution was $k = 4$. The final segmentation included clusters as follows: Cluster 1 contains 35 respondents (28\%), Cluster 2 contains 36 respondents (28\%), Cluster 3 contains 23 respondents (18\%), and Cluster 4 contains 31 respondents (24\%).
...
& + \texttt{define\_accommodation} + \texttt{less\_crowded\_willingness} \\
& + \texttt{extra\_travel\_time} \\
...
\indent As presented in Figure~\ref{fig:mnlogit_confmatrix}, the confusion matrix reveals an acceptable level of predictive accuracy, with clusters 1 and 2 achieving the highest correct classification rates. In contrast, Clusters 3 and 4 exhibit higher levels of overlap, indicating partial similarity in respondent profiles and less sharply defined behavioral boundaries. Furthermore, the model’s estimated coefficients (see Appendix~\ref{sec:final_model}) indicate that:

\begin{itemize}
\item Gender is a consistent discriminator, being statistically significant ($p < 0.05$) for clusters 2 and 4, suggesting differences in destination preferences between male and female travelers.
\item Age group shows a significant effect ($p < 0.05$) for cluster 3, implying that younger respondents are more likely to belong to this group, characterized by exploratory travel behavior.
...
\item Cultural engagement, represented by \texttt{contemporary\_cultural\_interest} \\ \texttt{(architectural\-\_interest)}, displayed a near-significant effect ($p = 0.07$) for cluster 3, indicating that interest in modern cultural experiences differentiates a specific segment of travelers.
\end{itemize}
...
\indent In summary, the final Multinomial Logit model achieved convergence with statistically robust predictors and interpretable results. The findings highlighting the relevance of age, gender, residence, and cultural orientation in explaining tourist segmentation.

\subsubsection{Van Westendorp Price-Sensitivity Method}

\indent The Van Westendorp analysis was applied to estimate respondents’ perceived price thresholds for the proposed tourism experience. Following the same methodological approach presented in section 3.3, sub-section 3.3.1 (from Appendix~\ref{sec:vwcode}), four key indicators were obtained: the Point of Marginal Cheapness (PMC), Point of Marginal Expensiveness (PME), Indifference Price Point (IPP), and Optimal Price Point (OPP). These values provide a reference framework for understanding perceived value and acceptable price ranges among different tourist segments.

\indent Considering the full sample (n = 125), results indicate an Optimal Price Point (OPP) of €200.18 and an Indifference Price Point (IPP) of €250.20, with the acceptable price range extending between approximately €200 and €250. This suggests that most respondents perceive prices within this interval as fair and aligned with their expectations of value for the proposed experience.
...
\item Cluster 2 exhibits similar patterns, with a PMC of €150.20 and a PME of €240.00. However, the Optimal Price Point could not be determined due to the crossing behavior of cumulative distributions, suggesting inconsistent or highly heterogeneous perceptions of value within this group. This is consistent with the higher standard deviations observed in their individual price responses, ranging from €49.2 for the “too cheap” threshold to €254.3 for “too expensive” responses.
\item Cluster 3 presents the widest acceptable price range, with a PMC of €200.10, a PME of €300.02, and an OPP of €200.10. This segment demonstrates lower price sensitivity and greater tolerance toward higher price levels, aligning with profiles that emphasize experiential or cultural value over cost considerations.
...
\indent Overall, the results reveal a general convergence around €200–€250 as the perceived fair price interval, though clusters differ in their sensitivity and upper price tolerance. Clusters 1 and 2 are the most price-constrained, while Cluster 3 exhibits the highest willingness to pay.

\subsubsection{Cluster Profiles: Socio-Demographic Composition}

\indent After applying the clustering procedure and validating the optimal solution at $k = 4$, the resulting segments were analyzed to describe their socio-demographic composition and distinctive attitudinal patterns. Appendix~\ref{sec:socio_demo} present the distribution of age, gender, residence, and professional status across the four clusters, illustrating clear structural differences among groups.
...
\item Cluster 2 (n = 36; 28\%) is characterized by a younger demographic, concentrated in the 18–25 and 26–35 year old ranges, with a slight predominance of male respondents. The majority are students or early-career professionals, primarily from Italy and other European countries.
...
\subsubsection{Cluster Profiles: Accommodation-Booking Behavior}

\indent The survey results indicate that the majority of respondents tend to book their accommodation in advance, while only a smaller proportion prefer to make last-minute reservations. This pattern reflects a predominant orientation toward planned travel behavior, which is consistent with the exploratory nature of leisure trips analyzed in this study.

\indent Figure~\ref{fig:accomm_adv} shows that, when booking in advance, the most frequently used channels across all clusters are online platforms such as Booking.com and Airbnb, followed by hotels’ official websites and, to a much lesser extent, travel agencies or personal recommendations. Clusters 2 and 3 display the highest reliance on digital platforms (around 48–51\%), suggesting a more digitally engaged and self-directed travel planning behavior. Cluster 1, while also showing a strong preference for online channels (42\%), presents slightly more diversity in platform use, including Airbnb (30\%) and hotel websites (14\%), which may indicate higher experimentation or comparison across options.

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Images/Quantitative Survey/Cluster Profiles/booking in advance.png}
    \captionsetup{font=footnotesize}
    \caption{\textit{Booking Channels Used in Advance. Source: Author’s own elaboration.}}
    \label{fig:accomm_adv}
\end{figure}

\indent When focusing on last-minute reservations (Figure~\ref{fig:lastminute}), the dominance of digital platforms remains, although with a narrower set of channels. In these cases, platforms as Booking and Airbnb again emerge as the leading options, while the relevance of personal recommendations increases slightly, particularly in Clusters 1 and 2, highlighting a tendency toward informal and opportunistic booking behaviors when travel plans are made spontaneously.
...
\indent One of the variables analyzed to better understand behavioral differences among clusters was the willingness to visit destinations located outside major tourist circuits. As illustrated in Figure~\ref{fig:less_known} (see Appendix~\ref{sec:less_known_app}), the results reveal that travelers’ interest in lesser-known cities is closely associated with their tolerance for longer travel times. Nevertheless, this relationship varies considerably across clusters, highlighting distinct motivational patterns among traveler groups.

\begin{itemize}
\item Cluster 1 displays a relatively low and heterogeneous willingness, with most respondents scoring between 2 and 3. This group tends to avoid travelling for this reason.
...
\item Cluster 4 reveals a mixed pattern, with moderate willingness for shorter additional travel times. This behavior may indicate a preference for alternative destinations only when they are easily accessible or conveniently located.
\end{itemize}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Images/Quantitative Survey/Cluster Profiles/city tours.png}
    \captionsetup{font=footnotesize}
    \caption{\textit{Preferred City Tour Type by Cluster. Source: Author’s own elaboration.}}
    \label{fig:citytour}
\end{figure}

\indent To further explore the motivations of travelers who avoid guided tours, an additional comparison was conducted examining their architectural and cultural interests (see Figure~\ref{fig:architecture_radar} in Appendix~\ref{sec:radar}). The results indicate that respondents who do not typically engage in city tours tend to express a stronger interest in historic public spaces and religious architecture. However, it is important to highlight that Cluster 4 exhibits the most diversified architectural appreciation, combining interest in medieval and historical elements with a notable openness toward modern and contemporary structures. Also, Cluster 2 shows greater interest in religious and classical sites, consistent with a more traditional form of cultural tourism.

\subsubsection{Cluster Profiles: Restaurant-Choice Behavior}

\indent The analysis of eating preferences across clusters reveals a clear inclination toward less crowded, local neighborhoods as preferred dining areas. Further exploration of restaurant selection criteria (Figure~\ref{fig:restaurant_choice}) provides additional insights into how respondents make dining decisions. The results show that the most common strategy, especially within Clusters 1 and 3, involves relying on online reviews like Google Maps, indicating the importance of digital validation. Meanwhile, Clusters 2 and 4 demonstrate a higher preference for personal recommendations and on-site decision-making, often deciding while walking by.

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Images/Quantitative Survey/Cluster Profiles/restaurant.png}
    \captionsetup{font=footnotesize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item In gastronomic behavior, they rely on online reviews and a have a moderate preference for less crowded areas. Their higher willingness to travel extra time for unique destinations suggests a motivation driven by freshness and cultural meaning.
    \end{itemize}

    \item Cluster 4 (the comfort-oriented urban visitor):
    \begin{itemize}
        \item This segment includes a more heterogeneous age range with both young professionals and mature travelers, mainly from South America. They prefer centrally located accommodation and organized environments, often showing lower interest in visiting less-known destinations.
        \item They still appreciate cultural authenticity, particularly heritage ambience and local dining options, but their choices are marked by comfort and accessibility rather than exploration. They value guided walking tours, and show moderate engagement with natural environments such as mountains or lakes. This group reflects the pragmatic urban tourist, who values cultural identity but prioritizes convenience and reliability.
    \end{itemize}
\end{itemize}
...
\indent In addition, this thesis adds more steps after the interviews. Text mining of Booking and Airbnb reviews supported and refined the attributes using a larger body of spontaneous feedback from real travelers. Then, an explanatory survey, supported by sentence embeddings and TF–IDF, helped check whether other attributes were missing. These steps led to a more solid list of final attributes.
...
\indent The main contribution of this thesis is its step-by-step structure. Each stage complements the others: interviews help build the first list of attributes, text mining refines that list, and surveys test whether the attributes explain real behavior. Using ranking questions, Gower distance, and K-Medoids made segmentation more coherent. Supporting clustering results with Random Forest and Multinomial Logit models increased interpretability. This combination of qualitative and quantitative approaches shows that it is possible to extract actionable attributes and validate them with data. The process is flexible and can be adapted to other destinations.
...
\begin{itemize}
    ...
    \item Attribute refinement could have benefited from additional rounds of explanatory or open-ended surveys.
...
\begin{itemize}
    ...
    \item Introducing additional rounds of qualitative or explanatory surveys to refine and validate attributes.
...
\indent This thesis proposed and tested a methodological framework for identifying, validating, and analysing tourism attributes through an integrated mixed-method approach. The research combined qualitative exploration, text mining, and quantitative validation to improve how relevant attributes of tourist behaviour are defined and assessed. The main goal was not to focus on a specific destination, but to design a replicable process that can produce reliable and actionable insights for tourism marketing and destination management.

\indent The work started with qualitative interviews that encouraged participants to describe real travel experiences, avoiding hypothetical or suggestive questions. This helped reveal authentic patterns of behaviour and reduce typical interview biases. The subsequent application of text mining techniques on interview transcripts and online reviews strengthened this process, transforming qualitative insights into measurable patterns. Using methods such as TF-IDF vectorisation and topic modeling techniques, the analysis identified recurring themes and attributes that would have been difficult to detect through manual review alone. This combination of human interpretation and computational analysis improved precision, consistency, and replicability compared with previous work, which relied mostly on manual coding and broader categories.

\indent The second stage focused on the quantitative validation of these attributes through a structured survey. Respondents ranked ten final attributes, which were also tested with Likert scales as a consistency check. Correlation analysis confirmed that participants responded coherently across both formats, supporting data reliability. The clustering analysis using Gower distance and K-Medoids revealed four distinct tourist segments, each characterised by different combinations of cultural, practical, and experiential preferences. The Random Forest analysis confirmed that accessibility to attractions, accommodation services, and proximity to nature were the strongest discriminating factors. The Multinomial Logit model further showed that age, gender, residence, and cultural orientation significantly influenced cluster membership. Together, these results demonstrate that integrating text mining within a mixed-method framework can successfully produce meaningful and data-driven segmentation based on validated attributes.

\indent The methodology also included exploratory steps such as the Van Westendorp analysis, which provided an initial view of price perception among clusters. This result reinforces the potential for integrating willingness to pay measures into future work, through conjoint or discrete choice experiments. The overall findings suggest that the attribute structure developed here is both theoretically consistent .and practically applicable to real world contexts.
...
\indent From a broader perspective, this research contributes to the methodological discussion in tourism analysis. It demonstrates how combining qualitative and quantitative techniques, supported by text and data mining, can generate richer and more reliable insights than using either approach alone. The framework combines exploratory discovery with statistical validation, creating a systematic process that other destinations can replicate or adapt to their specific contexts.
...
\begin{figure}[H]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Top Words from Airbnb Reviews. Source: Author’s own elaboration based on Inside Airbnb's dataset.}}
...
\begin{figure}[H]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Top Words from Booking.com Positive Reviews. Source: Author’s own elaboration based on Kaggle's dataset.}}
...
\begin{figure}[H]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Top Words from Booking.com Negative Reviews. Source: Author’s own elaboration based on Kaggle's dataset.}}
...
\begin{figure}[ht]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Description of Explanatory Survey Respondents (I). Source: Author’s own elaboration.}}
...
\begin{figure}[H]
    ...
    \captionsetup{font=footnotesize}
    \caption{\textit{Description of Explanatory Survey Respondents (II). Source: Author’s own elaboration.}}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Images/Explanatory Survey/Descriptive_main.png}
    \captionsetup{font=footnotesize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/Explanatory Survey/Descriptive_main2.png}
    \captionsetup{font=footnotesize}
    \captionof{figure}{\textit{Description of Explanatory Survey's Respondents. Source: Author’s own elaboration.}}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Images/Explanatory Survey/Van Westendorp.png}
    \captionsetup{font=footnotesize}
...
\appendixsection[sec:less_known_app]{Willingness to Visit Less-Known Destinations and Extra Travel Time}
